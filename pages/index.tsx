        ...
        <div className={styles.jumbotron}>
          ...
          <div className="container text-white text-center position-absolute top-50 start-50 translate-middle mt-4">
            ...
            <div className="d-flex align-items-center justify-content-center">
                <a href="https://instagram.com/fkhmeiwil7?igshid=YmMyMTA2M2Y=" target={'_blank'} className='btn p-0'>
                <img 
                ...
                <a href="https://liff.line.me/1645278921-kWRPP32q/?accountId=jga4294g" target={'_blank'} className='btn p-0 mx-3'>
                <img 
              ...
              <a href="https://youtube.com/channel/UCVapmaJ1gxLvAgzA6QwyFMg" target={'_blank'} className='btn p-0 mx-3'>
                <img 
